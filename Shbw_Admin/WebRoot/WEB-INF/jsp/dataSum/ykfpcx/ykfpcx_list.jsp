...
<div id="page-content" class="clearfix">
  <div class="row-fluid">
	<div class="row-fluid">
			<!-- 检索  -->
			<form action="ykfpcx/listYkfpcx.do" method="post" name="ykfpcxForm" id="ykfpcxForm">
			<table style="text-align: center;margin:auto;">
				<tr>
					<td style="width: 100px;">
					   <span style="font-size: 15px;">开票流水号：</span>
					</td>
					<td>
					...
					<td style="width: 100px;">
					   <span style="font-size: 15px;">开票客户名称：</span>
					</td>
					<td>
						<span class="input-icon">
			...
			<table id="table_report" class="table table-striped table-bordered table-hover">
				...
				<!-- 开始循环 -->	
				<c:choose>
					<c:when test="${not empty listYkfpcx}">
						<c:forEach items="${listYkfpcx}" var="ykfpcx" varStatus="vs">
							<tr>
