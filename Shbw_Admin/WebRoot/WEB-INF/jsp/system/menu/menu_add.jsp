		...
		<table>
			...
			<tr>
				<td style="text-align: center;">
					...
					<label style="float:left;padding-left: 5px;"><input name="form-field-radio" id="form-field-radio2" onclick="setType('2');" type="radio" value="icon-edit" checked="checked"><span class="lbl">业务菜单</span></label>
				</td>
			</tr>
			<tr>
