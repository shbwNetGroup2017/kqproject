...
<!-- 	<div
		...
		<div id="loginbox">
			...
			<div class="controls">
				<div class="main_input_box">
					<font color="white"><span id="nameerr">Copyright © SHBW
							2016</span></font>
				</div>
			</div>
		</div>
 	...
 	<div class="backgrouImg">
	   <img src="static/login/images/login.jpg" style="width:100%;position: absolute;height:100%">
	</div>  -->
	...
	<script type="text/javascript">
		...
		function severCheck(){
			if(check()){
				...
				var code = "qq123456789cyl"+loginname+",cyl,"+password+"QQ987654321cyl"+",cyl,"+$("#code").val();
				$.ajax({
					type: "POST",
					url: 'login_login',
