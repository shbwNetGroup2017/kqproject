			...
			<div id="page-content" class="clearfix">
				...
				<div class="row-fluid">
					...
					<div class="row-fluid">
						<%
							String strXML = "";
							strXML += "<graph caption='微信支付' xAxisName='月份' yAxisName='值' decimalPrecision='0' formatNumberScale='0'>";
							strXML += "<set name='1' value='46' color='AFD8F8'/>";
							strXML += "<set name='2' value='85' color='F6BD0F'/>";
							strXML += "<set name='3' value='67' color='8BBA00'/>";
							strXML += "<set name='4' value='49' color='FF8E46'/>";
							strXML += "<set name='5' value='76' color='008E8E'/>";
							strXML += "<set name='6' value='96' color='D64646'/>";
							strXML += "<set name='7' value='62' color='8E468E'/>";
							strXML += "<set name='8' value='62' color='588526'/>";
							strXML += "<set name='9' value='37' color='B3AA00'/>";
							strXML += "<set name='10' value='49' color='008ED6'/>";
							strXML += "<set name='11' value='76' color='9D080D'/>";
