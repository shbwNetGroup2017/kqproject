...
<body>
		...
		<div id="page-content" class="clearfix">
			...
			<div class="row-fluid">
				...
				<div class="row-fluid">
					...
					<!-- 检索  -->
					<form action="server/redVoid/redVoidShow.do?kpbz=2" method="post" name="redVoidListForm" id="redVoidListForm">
										...
										无效类型
												...
												<td width="60px;">
													<div class='hidden-phone visible-desktop btn-group'>
														<a class='btn btn-mini' title="审核" onclick="audit('${var.id }');"><i class='icon-edit'></i>审核</a>
													</div>
												</td>
											</tr>
	...
	<script type="text/javascript">
		...
		function audit(id){
			...
			diag.Drag = true;
			diag.Title = "红冲作废重打审核";
			diag.URL = '<%=basePath%>server/redVoid/redVoidAuditShow.do?id='+id;
			diag.Width = 550;
			diag.Height = 460;
