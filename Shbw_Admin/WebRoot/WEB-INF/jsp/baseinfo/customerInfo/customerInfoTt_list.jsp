		...
		<div id="page-content" class="clearfix">
			...
			<div class="row-fluid">
				...
				<div class="row-fluid">
					...
					<!-- 检索  -->
					<form action="server/customer/customerTtList.do" method="post" name="customerInfoForm" id="customerInfoForm">
						<table style="text-align: center; margin: auto;">
							...
							<tr>
								...
								<td style="vertical-align: top; text-align: left;" colspan="1"><a class="btn btn-mini btn-light" onclick="clearSearch()" title="重置"> <i id="nav-search-icon" class="icon-refresh">重置</i>
								</a></td>
							</tr>
						</table>
						</form>
						...
						<td style="vertical-align: top;"><a style="width: 100px;" class="btn btn-small btn-success" onclick="makeAll('确定选中客户为抬头?');">确定</a></td>
						<form action="server/customer/customerTtFjInfo.do" method="post" name="customerTtInfoForm" id="customerTtInfoForm" enctype="multipart/form-data">
				...
				if(confirm(msg)){ 
						...
						if(str==''){
							...
							if(msg == '确定选中客户为抬头?'){	
								...
								//customerTtInfoForm
								var form=$("#customerTtInfoForm");
								$("#customerTtInfoForm").ajaxSubmit({
								url : 'server/customer/customerTtFjInfo.do',
